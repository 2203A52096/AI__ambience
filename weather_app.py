...
if page == "Home":
    st.title("🌍 Welcome to Clim-AI-te")
    st.markdown("""
        **An AI-powered climate prediction assistant!** ❄️🌤️☔
    ...
    if st.button("Click for a Weather Joke!"):
        st.markdown(f"**Fun Fact:** {random.choice(weather_jokes)}")
    ...
    st.write(clothing_recommendations[weather_choice])
    st.subheader("🍲 Food Recommendation")
    st.write(food_recommendations[weather_choice])
